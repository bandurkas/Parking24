...
export const metadata: Metadata = {
  ...
  description:
    "Охраняемая парковка в 500 метрах от Шереметьево. Бесплатный трансфер до терминалов от 4 суток, комнаты отдыха, охрана и видеонаблюдение 24/7. Бронирование онлайн.",
  keywords: [
