  ...
  return (
    ...
    >
      ...
      <span className="absolute inset-0 flex items-center justify-center bg-navy/15 transition-colors duration-200 group-hover:bg-navy/25">
        <span className="flex items-center gap-2 rounded-xl bg-white px-5 py-3 text-[15px] font-semibold text-primary-deep shadow-card-lg transition-colors duration-200 group-hover:bg-cta group-hover:text-ink">
