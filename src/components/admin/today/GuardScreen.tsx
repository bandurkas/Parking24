...
export default function GuardScreen({ today, rows, user, shift = null, myShift }: { today: string; rows: Rows; user: SessionUser; shift?: OpenShiftBrief; myShift?: React.ReactNode }) {
