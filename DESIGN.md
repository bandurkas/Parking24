...
### Chips
- **Style:** пилюли (999px) на Morning Haze, текст Jet Stream Gray 14px/500; вариант с пиктограммой — цветная PNG-иконка 24px слева (стиль МТС, Nano Banana Pro), асимметричный паддинг 10px слева / 16px справа.
...
- **Do** используй lucide-иконки stroke 2px для UI и цветные NBP-пиктограммы только в чипах услуг — не смешивай стили внутри одного блока.
